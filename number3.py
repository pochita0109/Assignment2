...
for i in range(len(nospace_message)):
     ...
     # Convert the letters of keyword into number 
...
while True:
    continue_cipher = input("\033[97mDo you want to continue? (yes or no): ")
    if continue_cipher == "no":
      print("\033[97mThank you for using Kenneth's Vigenere Cipher".center(100, "*"))
      exit()

    if continue_cipher == "yes":
      name = input("Please enter your name: ")
      message_input = input("Please enter the message: ")
      key_input = input("Please enter the keyword: ")
      break
